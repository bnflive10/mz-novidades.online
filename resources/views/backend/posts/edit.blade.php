		...
		<div class="col-sm-12">
			<div class="row">
				<form method="post" action="{{url('updatepost')}}/{{$data->pid}}" enctype="multipart/form-data">
					...
					<input class="hidden" name="pid" value="{{$data->pid}}"></input>
					<div class="col-sm-9">
						<div class="form-group">	
							<input type="text" name="title" id="category_name" class="form-control" placeholder="Enter title here" value="{{$data->title}}">				
						</div>
						<div class="form-group">	
					...
					<div class="col-sm-3">
						...
						<div class="content featured-image">
							...
							<p><label for="file" style="cursor: pointer;">Trocar Featured Image</label></p>
							@else
