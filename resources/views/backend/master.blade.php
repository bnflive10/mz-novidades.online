...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{url('public/css/bootstrap2.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{url('public/css/font-awesome2.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{url('public/css/ionicons.min.css')}}">
	<link rel="stylesheet" type="text/css" href="{{url('public/css/menu2.css')}}">
	<link rel="stylesheet" type="text/css" href="{{url('public/css/adminstyle.css')}}">	

  <script type="text/javascript" src="{{url('public/js/jquery2.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/js/bootstrap2.min.js')}}"></script>
<script type="text/javascript" src="{{url('public/js/app2.min.js')}}"></script>
	...
	<ul class="sidebar-menu">
		...
		<li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="{{url('category')}}"><i class="fa fa-plus-circle"></i>Categorias</a></li>
            </ul>
        </li>
        <li class="treeview">
            <a href="#">
