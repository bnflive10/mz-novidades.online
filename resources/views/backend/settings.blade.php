		...
		<div class="col-sm-4 cat-form">
			...
			<form method="post" action="{{url('addsettings')}}" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<p><label for="file" style="cursor: pointer;" class="btn btn-warning">Upload Imagem</label></p>
					<p><img id="output"/></p>
				</div>
				<div class="form-group">
					<label>Sobre Nos</label>
				...
				<div id="socialFieldGroup">
					<div class="form-group">
						...
						<p class="text-muted">ex: https://www.facebook.com/mz-novidades</p>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="alert alert-danger alert-dismissable noshow" id="socialAlert">
						<a href="#" class="close" data-dismiss="alert">&times;</a>
						<strong>Desculpa!</strong> Ja atingiu o limite de campos para redes sociais.
					</div>
			...
			<form method="post" action="{{url('updatesettings')}}/{{$data->sid}}" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<p><input type="file"  accept="image/*" name="image" id="file"  onchange="loadFile(event)" style="display: none;"></p>
					<p><label for="file" style="cursor: pointer;" class="btn btn-warning">Trocar Imagem</label></p>
					@else
					<p><input type="file"  accept="image/*" name="image" id="file"  onchange="loadFile(event)" style="display: none;"></p>
					<p><label for="file" style="cursor: pointer;" class="btn btn-warning">Upload Imagem</label></p>
					<p><img id="output"/></p>
